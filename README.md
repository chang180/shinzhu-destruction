...
預計完整重製為最新版穩定 Laravel + Vue、SQLite 與 Hostinger PHP 共享空間上的 **限時卡牌策略遊戲，規劃 3 關主線＋2 關進階挑戰**。P01 已完成 Laravel 13.30.1、Vue 3.5.42、Vite 8.2.2、TypeScript 5.9.3、SQLite 與 Laravel Boost 2.7.1 基礎；P02 已完成三個中央部會資料 adapter、正規化快照與示範情境備援；P03 已完成伺服器權威戰鬥引擎、事件契約與平衡鎖版。五關內容、正式視聽與 Hostinger 實機驗證仍按階段進行。P04 真人試玩後改版中，限時／手牌尚未實作，見[試玩後改版計畫](docs/P04-REVISION-PLAN.md)。
...
- 舊切片已有自動測試與桌機／手機畫面證據。2026-09-09 真人試玩提出在地招式、緊張感、卡牌主畫面及關卡數問題；使用者選定每回合 30 秒與五張手牌。P04 改回「進行中」，新版程式、錄影與再次試玩尚未完成。
